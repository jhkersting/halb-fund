...
weights <- (seq_along(ts_data_diff[,1]) / length(ts_data_diff[,1])) ^ (0.5)
...
title('Yield Curve for Jan. 1, 2024')
...
# add title
title('Discount Curve for Jan. 1, 2024')
