...
ABMInputData$StockPrice = 100
ABMInputData$StrikePrice = 100
ABMInputData$InterestRate = 5.0
ABMInputData$DividendYield = 0.0
ABMInputData$Volatility = 29.88476829 #29.88476829
ABMInputData$TimeToMaturity = 1.0
ABMInputData$Type = 1
CallValue = ABMOptionValue(ABMInputData)
ABMInputData$Type = -1
PutValue = ABMOptionValue(ABMInputData)
...
ABMInputData$StockPrice = 1
ABMInputData$StrikePrice = 1
ABMInputData$Type = 1
CallValue = ABMOptionValue(ABMInputData)
ABMInputData$Type = -1
PutValue = ABMOptionValue(ABMInputData)
...
ABMInputData$StrikePrice = 0
ABMInputData$Type = 1
LLCallValue = ABMOptionValue(ABMInputData)
ABMInputData$Type = -1
LLPutValue = ABMOptionValue(ABMInputData)

LLCallValue; LLPutValue; ABMInputData$StockPrice+LLPutValue
