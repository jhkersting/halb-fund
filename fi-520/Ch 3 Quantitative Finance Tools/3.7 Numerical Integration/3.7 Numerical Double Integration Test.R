...
#  plot3D: mesh()
Packages <- c("stats", "pbivnorm", "mvtnorm", "pracma") 
...
persp(x = x3, y = y3, z = N2CDFV1, colkey = FALSE, 
  main = mTitle1, phi = phi1, theta = theta1, 
  xlim = xlim1, ylim = ylim1, zlim = zlim1,
  xlab = xTitle, ylab = yTitle, zlab = zTitle,
  axes = TRUE, scale=TRUE, box=TRUE)
persp(x = x3, y = y3, z = N2CDFV2, colkey = FALSE,
       main ="Bivariate CDF (pmvnorm)", col=NULL)
persp(x = x3, y = y3, z = N2CDFV3, colkey = FALSE,
       main ="Standard Bivariate CDF (pbivnorm)")
persp(x = x3, y = y3, z = Error12, colkey = TRUE, 
       main ="Error (integral2 - pmvnorm)")
persp(x = x3, y = y3, z = Error13, colkey = TRUE, 
       main ="Error (integral2 - pbivnorm)")
persp(x = x3, y = y3, z = Error23, colkey = TRUE, 
