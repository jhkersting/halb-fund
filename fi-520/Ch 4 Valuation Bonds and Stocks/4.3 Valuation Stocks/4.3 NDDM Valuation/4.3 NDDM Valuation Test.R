...
write.xlsx(Div, file = "Dividends.xlsx", colNames = TRUE, 
  sheetName = "Dividends", showNA = TRUE, rowNames = FALSE)
write.xlsx(Series, file = "Series.xlsx", colNames = TRUE, 
  sheetName = "Series", showNA = TRUE, rowNames = FALSE)
