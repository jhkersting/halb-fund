...
plot(Volatility, CallGBMValue, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutGBMValue, type = "l", col ="black", xlim = xlim1, ylim = ylim1,
  pch = 2, cex = 0.5)
...
xTitle = "Volatility"
yTitle = "Option Value"
plot(Volatility, CallEuropeanBinomialValue, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialValue, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialValue, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialValue, type = "l", col ="black", 
...
xTitle = "Volatility"
yTitle = "Difference"
plot(Volatility, CallDifference, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutDifference, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
...
xTitle = "Volatility"
yTitle = "Option Delta"
plot(Volatility, CallEuropeanBinomialDelta, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialDelta, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialDelta, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialDelta, type = "l", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 4, cex = 0.5)
...
xTitle = "Volatility"
yTitle = "Option Gamma"
plot(Volatility, CallEuropeanBinomialGamma, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialGamma, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialGamma, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialGamma, type = "l", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 4, cex = 0.5)
legend("right", legtxt, cex = 0.75, lwd = c(1,1,1,1), lty = c(1,1,1,1), bty = "n",
  col = c("black","black","black","black"), pch = c(NA,NA,NA,NA), title = lTitle)
...
xTitle = "Volatility"
yTitle = "Option Theta"
plot(Volatility, CallEuropeanBinomialTheta, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialTheta, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialTheta, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialTheta, type = "l", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 4, cex = 0.5)
...
xTitle = "Volatility"
yTitle = "Option Vega"
plot(Volatility, CallEuropeanBinomialVega, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialVega, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialVega, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialVega, type = "l", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 4, cex = 0.5)
...
xTitle = "Volatility"
yTitle = "Option Rho"
plot(Volatility, CallEuropeanBinomialRho, type = "l", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(Volatility, PutEuropeanBinomialRho, type = "l", col ="black", xlim = xlim1, 
  ylim = ylim1, pch = 2, cex = 0.5)
lines(Volatility, CallAmericanBinomialRho, type = "l", col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
lines(Volatility, PutAmericanBinomialRho, type = "l", col ="black", xlim = xlim1, 
