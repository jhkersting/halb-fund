...
for(i in 1:NumberOfObservations){
  ...
  ABMInputData$Type = 1
  CallVLowerBound[i] <- OptionLowerBound(ABMInputData)
  CallVUpperBound[i] <- OptionUpperBound(ABMInputData)
  ...
  # CallABMRho[i] <- ABMOptionNRho(ABMInputData)
  ABMInputData$Type = -1
  PutVLowerBound[i] <- OptionLowerBound(ABMInputData)
  PutVUpperBound[i] <- OptionUpperBound(ABMInputData)
...
# American-style binomial
  ...
  # Gamma <- ABMASBINOptionGammaDirect(BINInputData)
  # Gamma <- ABMASBINOptionNGamma(BINInputData)
...
lTitle = "Parameter"
#
# ABM Value Plots (Closed form only)
#
...
xTitle = "Stock Price"
yTitle = "ABMOVM Value"
plot(StockPrice, CallABMValue, type = "b", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", xlim = xlim1, 
  ylim = ylim1, pch = 1, cex = 0.5)
lines(StockPrice, PutABMValue, type = "b", col ="black", xlim = xlim1, 
...
xTitle = "Stock Price"
yTitle = "Delta"
plot(StockPrice, CallABMDelta, type = "b", main = mTitle,
...
lines(StockPrice, PutABMDelta, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
...
xTitle = "Stock Price"
yTitle = "Gamma"
plot(StockPrice, CallABMGamma, type = "b", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 1, cex = 0.5)
lines(StockPrice, CallAmericanBinomialGamma, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 2, cex = 0.5)
lines(StockPrice, PutABMGamma, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
...
xTitle = "Stock Price"
yTitle = "Theta"
plot(StockPrice, CallABMTheta, type = "b", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 1, cex = 0.5)
lines(StockPrice, CallAmericanBinomialTheta, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 2, cex = 0.5)
lines(StockPrice, PutABMTheta, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
...
xTitle = "Stock Price"
yTitle = "Vega"
plot(StockPrice, CallABMVega, type = "b", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 1, cex = 0.5)
lines(StockPrice, CallAmericanBinomialVega, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 2, cex = 0.5)
lines(StockPrice, PutABMVega, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
...
xTitle = "Stock Price"
yTitle = "Rho"
plot(StockPrice, CallABMRho, type = "b", main = mTitle,
  sub = sTitle, xlab = xTitle, ylab = yTitle, col = "black", 
  xlim = xlim1, ylim = ylim1, pch = 1, cex = 0.5)
lines(StockPrice, CallAmericanBinomialRho, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 2, cex = 0.5)
lines(StockPrice, PutABMRho, type = "b", col ="black", 
  xlim = xlim1, ylim = ylim1, pch = 3, cex = 0.5)
